let but = document.getElementById("flexSwitchCheckChecked8");
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag7").addEventListener('click' ,function(){
   goto("../online_auction_platform.html","Luxury_houses_in_another_page");
   }); 


   
   const targetDate = new Date("2025-04-04T03:23:54").getTime();
