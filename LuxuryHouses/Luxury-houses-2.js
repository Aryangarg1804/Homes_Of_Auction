let but = document.getElementById("flexSwitchCheckChecked6")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag5").addEventListener('click' ,function(){
   goto("../index.html","Luxury_houses_in_another_page");
   }); 

   
   const targetDate = new Date("2025-03-31T03:43:23").getTime();
