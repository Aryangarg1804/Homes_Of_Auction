let but = document.getElementById("flexSwitchCheckChecked5")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag4").addEventListener('click' ,function(){
   goto("../online_auction_platform.html","Luxury_houses_in_another_page");
   }); 



   const targetDate = new Date("2025-03-31T05:34:54").getTime();
