let but = document.getElementById("flexSwitchCheckChecked7")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag6").addEventListener('click' ,function(){
