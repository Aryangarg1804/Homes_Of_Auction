let but = document.getElementById("flexSwitchCheckChecked15")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag14").addEventListener('click' ,function(){
   goto("../index.html","Budget_friendly_Houses_in other_page");
   }); 


   const targetDate = new Date("2025-05-01T10:34:32").getTime();
