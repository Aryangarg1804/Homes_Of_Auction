let but = document.getElementById("flexSwitchCheckChecked14")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag13").addEventListener('click' ,function(){
   goto("../online_auction_platform.html","Budget_friendly_Houses_in other_page");
   }); 


   const targetDate = new Date("2024-11-28T03:32:12").getTime();
