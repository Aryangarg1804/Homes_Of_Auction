let but = document.getElementById("flexSwitchCheckChecked16")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag15").addEventListener('click' ,function(){
   goto("../index.html","Budget_friendly_Houses_in other_page");
   }); 


   const targetDate = new Date("2024-12-05T00:09:02").getTime();
