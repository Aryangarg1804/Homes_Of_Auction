let but = document.getElementById("flexSwitchCheckChecked11")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag10").addEventListener('click' ,function(){
   goto("../index.html","Affordable_Houses_in other_page");
   }); 



   const targetDate = new Date("2024-11-28T02:23:45").getTime();
