let but = document.getElementById("flexSwitchCheckChecked10")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag9").addEventListener('click' ,function(){
   goto("../index.html","Affordable_Houses_in other_page");
   }); 



   const targetDate = new Date("2024-11-29T03:28:52").getTime();
