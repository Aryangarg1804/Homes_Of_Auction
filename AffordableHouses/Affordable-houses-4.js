let but = document.getElementById("flexSwitchCheckChecked12");
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag11").addEventListener('click' ,function(){
   goto("../index.html","Affordable_Houses_in other_page");
   }); 



   const targetDate = new Date("2024-12-09T08:35:12").getTime();
