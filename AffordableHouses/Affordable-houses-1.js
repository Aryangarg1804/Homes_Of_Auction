let but = document.getElementById("flexSwitchCheckChecked9")
let ans=true;
...
function goto(page,scroll) {
   ...
   document.getElementById("drag8").addEventListener('click' ,function(){
   goto("../index.html","Affordable_Houses_in other_page");
   }); 


   const targetDate = new Date("2024-12-02T10:32:31").getTime();
