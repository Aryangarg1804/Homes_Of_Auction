let but = document.getElementById("flexSwitchCheckChecked3")
let ans=true;
...
document.getElementById("drag2").addEventListener('click' ,function(){
    goto("../index.html", "recomended-properties_in_another_page");
}); 


const targetDate = new Date("2025-04-02T04:24:06").getTime();
